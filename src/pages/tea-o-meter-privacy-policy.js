...
const TeaOMeterPrivacyPolicyPage = () => (
  <Layout>
    <Seo title="Tea-O-Meter Privacy Policy" />
    <span sx={{
      display: 'block',
    ...
    <div data-custom-class="body">
      ...
      <div sx={{ lineHeight: "1.5" }}>
        <span sx={{ color: 'rgb(127, 127, 127)' }}>
          <span sx={{ color: 'rgb(89, 89, 89)' , fontSize: '15px' }}>
            <span data-custom-class="body_text">This Privacy Notice for <bdt class="question">Adrian Chia<bdt
            ...
            <span data-custom-class="body_text">), describes how and why we might access, collect, store, use, and/or share
              ...
              "<strong>Services</strong>"<bdt class="statement-end-if-in-editor"></bdt>), including when you:</span>
          </span>
        </span>
        <span sx={{ fontSize: '15px' }}>
          <span sx={{ color: 'rgb(127, 127, 127)' }}>
          ...
          <span sx={{ color: 'rgb(89, 89, 89)' , fontSize: '15px' }}>
            <span sx={{ color: 'rgb(89, 89, 89)' , fontSize: '15px' }}>
              <span data-custom-class="body_text">Download and use<bdt class="block-component"></bdt> our mobile application
                <bdt class="block-component"></bdt> (<bdt class="question">Tea-O-Meter)<span sx={{ color: 'rgb(89, 89, 89)'
                    , fontSize: '15px' }}>
                    <span sx={{ color: 'rgb(89, 89, 89)' , fontSize: '15px' }}>
                      <span data-custom-class="body_text">
                        <span sx={{ fontSize: '15px' }}>
        ...
        <span sx={{ fontSize: '15px' }}>
          <span sx={{ color: 'rgb(127, 127, 127)' }}>
            <span data-custom-class="body_text">
              ...
              If you do not agree with our policies and practices, please do not use our Services.<bdt
                class="block-component"></bdt> If you still have any questions or concerns, please contact us at <bdt
                class="question">achia@adrianchia.com</bdt>.
            </span>
          </span>
        </span>
      </div>
          ...
          <span data-custom-class="body_text">
            <strong>
              <em>This summary provides key points from our Privacy Notice, but you can find out more details about any of
                these topics by clicking the link following each key point or by using our </em>
            </strong>
          </span>
        </span>
      ...
      <div sx={{lineHeight: '1.5' }}>
        <span sx={{ fontSize: '15px' }}>
          <span data-custom-class="body_text"><strong>Do we process any sensitive personal information? </strong>Some of the
            ...
            sexual orientation, and religious beliefs. <bdt class="block-component"></bdt>We do not process sensitive
      ...
      <div sx={{lineHeight: '1.5' }}>
        <span sx={{ color: 'rgb(89, 89, 89)' , fontSize: '15px' }}>
          <span sx={{ color: 'rgb(89, 89, 89)' , fontSize: '15px' }}>
            ...
            <span data-custom-class="body_text">express an interest in obtaining information about us or our products and
              Services, when you participate in activities on the Services, or otherwise when you contact us.</span>
          </span>
        </span>
      </div>
              ...
              <span sx={{ color: 'rgb(89, 89, 89)' , fontSize: '15px' }}>
                <span sx={{ color: 'rgb(89, 89, 89)' , fontSize: '15px' }}>
                  <span data-custom-class="body_text">
                    ...
                    <em>We process your information to provide, improve, and administer our Services, communicate with you,
        ...
        <em>
          <span sx={{ fontSize: '15px' }}>
            <span data-custom-class="body_text">
              ...
              </bdt> legal basis) to do so under applicable law, like with your consent, to comply with laws, to provide you
              with services to enter into or <bdt class="block-component"></bdt>fulfill<bdt
                ...
                class="block-component"></bdt>fulfill<bdt class="statement-end-if-in-editor"></bdt> our legitimate business
              interests.
            </span>
          </span>
        </em>
      ...
      <div sx={{lineHeight: '1.5' }}><span sx={{ color: 'rgb(89, 89, 89)' , fontSize: '15px' }}><span
            sx={{ color: 'rgb(89, 89, 89)' , fontSize: '15px' }}><span data-custom-class="body_text">We have implemented
              ...
              <bdt class="block-component"></bdt>unauthorized<bdt class="statement-end-if-in-editor"></bdt> third
          ...
          sx={{ color: 'rgb(89, 89, 89)' , fontSize: '15px' }}><span sx={{ color: 'rgb(89, 89, 89)' , fontSize: '15px' }}><span
              data-custom-class="body_text"><strong><em>In Short:</em></strong><em> <span
                ...
                <bdt class="block-component"></bdt>Depending on your state of residence in the US or in <bdt
                  class="else-block"></bdt>some regions, such as <bdt class="block-component"></bdt>the European Economic
                Area
      ...
      <div sx={{lineHeight: '1.5' }}><span sx={{ color: 'rgb(89, 89, 89)' , fontSize: '15px' }}><span
            sx={{ color: 'rgb(89, 89, 89)' , fontSize: '15px' }}><span data-custom-class="body_text">In some regions (like <bdt
              ...
              automated decision-making. In certain circumstances, you may also have the right to object to the processing
              of
              your personal information. You can make such a request by contacting us by using the contact details provided
              in
      ...
      <div sx={{lineHeight: '1.5' }}>
        <span sx={{ fontSize: '15px' }}>
          <span data-custom-class="body_text">However, please note
            ...
            </bdt> when applicable law allows,<bdt class="statement-end-if-in-editor"></bdt> will it affect the processing
            of
            your personal information conducted in reliance on lawful processing grounds other than consent.<bdt
              class="block-component"></bdt>
          </span>
        </span>
        <bdt class="block-component">
      ...
      <div id="DNT" sx={{lineHeight: '1.5' }}><span sx={{ color: 'rgb(127, 127, 127)' }}><span
          ...
          sx={{ color: 'rgb(89, 89, 89)' , fontSize: '15px' }}><span sx={{ color: 'rgb(89, 89, 89)' , fontSize: '15px' }}><span
              ...
              browsing activities monitored and collected. At this stage, no uniform technology standard for <bdt
                class="block-component"></bdt>recognizing<bdt class="statement-end-if-in-editor"></bdt> and implementing DNT
              signals has been <bdt class="block-component"></bdt>finalized<bdt class="statement-end-if-in-editor"></bdt>.
              As
              such, we do not currently respond to DNT browser signals or any other mechanism that automatically
              communicates
      ...
      <div id="uslaws" sx={{lineHeight: '1.5' }}><span sx={{ color: 'rgb(127, 127, 127)' }}><span
          ...
          sx={{ color: 'rgb(89, 89, 89)' , fontSize: '15px' }}><span sx={{ color: 'rgb(89, 89, 89)' , fontSize: '15px' }}><span
              data-custom-class="body_text"><strong><em>In Short: </em></strong><em>If you are a resident of<bdt
                ...
                Tennessee,
                Texas, Utah, or Virginia<bdt class="else-block"></bdt>, you may have the right to request access to and
              ...
              ssx={{ color: 'rgb(89, 89, 89)' , fontSize: '15px' }}><span data-custom-class="body_text"><span
                  ssx={{ color: 'rgb(89, 89, 89)' , fontSize: '15px' }}><span data-custom-class="body_text">
                    ...
                    <span data-custom-class="body_text">
                      ...
                      <bdt class="question">achia@adrianchia.com</bdt>, <bdt class="statement-end-if-in-editor"></bdt>
      ...
      <div sx={{lineHeight: '1.5' }}><span sx={{ fontSize: '15px' }}><span data-custom-class="body_text">Under certain US
            ...
            an
            <bdt class="block-component"></bdt>authorized<bdt class="statement-end-if-in-editor"></bdt> agent that does not
            submit proof that they have been validly <bdt class="block-component"></bdt>authorized<bdt
              class="statement-end-if-in-editor"></bdt> to act on your behalf in accordance with applicable
            laws.
          </span><br /><strong><span data-custom-class="heading_2">
              <h3>Request Verification</h3>
            </span></strong><span data-custom-class="body_text">Upon receiving your request, we will need to verify your
            identity to determine you are the same person about whom we have the information in our system. We will only use
            personal information provided in your request to verify your identity or authority to make the request. However,
      ...
      <div sx={{lineHeight: '1.5' }}>
        <span sx={{ fontSize: '15px' }}>
          <span data-custom-class="body_text">If you submit the request through an <bdt class="block-component"></bdt>
            ...
            the agent will need to provide a written and signed permission from you to submit such request on your
            behalf.</span>
        </span>
        <bdt class="block-component">
          <span sx={{ fontSize: '15px' }}></span>
        ...
        <span sx={{ fontSize: '15px' }}>
          ...
          <span data-custom-class="body_text">Under certain US state data protection laws, if we decline to take action
            regarding your request, you may appeal our decision by emailing us at <bdt class="block-component"></bdt>
            <bdt class="question">achia@adrianchia.com</bdt>
            <bdt class="else-block"></bdt>. We will inform you in writing of any action taken or not taken in response to
            the
        ...
        <span sx={{ fontSize: '15px' }}>
          ...
          <span data-custom-class="body_text">California Civil Code Section 1798.83, also known as the <bdt
              class="block-component"></bdt>"Shine The Light"<bdt class="statement-end-if-in-editor"></bdt> law, permits our
            ...
            your request in writing to us by using the contact details provided in the section <bdt class="block-component">
      ...
      <div id="request" sx={{lineHeight: '1.5' }}><span sx={{ color: 'rgb(127, 127, 127)' }}><span
        ...
        <span sx={{ color: 'rgb(89, 89, 89)' , fontSize: '15px' }}><span sx={{ color: 'rgb(89, 89, 89)' , fontSize: '15px' }}><span
              ...
              <bdt class="block-component"></bdt>Based on the applicable laws of your country<bdt class="block-component">
                ...
                class="else-block">
                <bdt class="block-component"> have the right to request access to the personal information we collect from
                  you, details about how we have processed it, correct inaccuracies, or delete your personal information.
                  You
                  may also have the right to <bdt class="block-component"></bdt>withdraw your consent to our processing of
            ...
            </span></span><span data-custom-class="body_text">.</span></span>
      </div>
    </div>
  </Layout>
)

export default TeaOMeterPrivacyPolicyPage
