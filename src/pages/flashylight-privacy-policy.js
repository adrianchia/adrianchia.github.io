...
import './flashylight-privacy-policy.css'
...
const PrivacyPolicyPage = () => (
  <Layout>
    ...
    <div data-custom-class="body">
        ...
        <span sx={{
          ...
          <strong>
            <span sx={{fontSize: '15px'}}>
              <span data-custom-class="subtitle">Last updated <bdt class="question">June 05, 2024</bdt></span>
            </span>
          </strong>
        </span>
      </div>
      ...
      <div sx={{
        ...
        <span sx={{
          ...
          <span sx={{
            ...
            <span data-custom-class="body_text">This privacy notice for <bdt class="question">Adrian Chia<bdt class="block-component"></bdt></bdt> (<bdt class="block-component"></bdt>"<strong>we</strong>," "<strong>us</strong>," or "<strong>our</strong>"<bdt class="statement-end-if-in-editor"></bdt></span>
        ...
        <li data-custom-class="body_text" sx={{lineHeight: '1.5'}}>
          <span sx={{
            ...
            <span sx={{
              ...
              <span data-custom-class="body_text">Download and use<bdt class="block-component"></bdt> our mobile application
              <bdt class="block-component"></bdt> (<bdt class="question">FlashyLight)<span
                  sx={{
              fontSize: '15px',
              color: 'rgb(89, 89, 89)'
            }}><span
              ...
              color: 'rgb(89, 89, 89)'
                        ...
                        sx={{fontSize: '15px'}}><span sx={{color: 'rgb(89, 89, 89)'}}><span
                            data-custom-class="body_text"><span sx={{fontSize: '15px'}}><span
              ...
              data-custom-class="body_text"><span sx={{fontSize: '15px'}}><span sx={{color: 'rgb(89, 89, 89)'}}><span
                    data-custom-class="body_text"><span sx={{fontSize: '15px'}}><span sx={{color: 'rgb(89, 89, 89)'}}>
      ...
      <div sx={{lineHeight: '1.5'}}><span sx={{fontSize: '15px'}}><span sx={{color: 'rgb(127, 127, 127)'}}><span
            data-custom-class="body_text"><span sx={{color: 'rgb(89, 89, 89)'}}><span data-custom-class="body_text">
                <bdt class="block-component"></bdt>
              </span></span></span></span></span>
      </div>
      <ul>
        <li data-custom-class="body_text" sx={{lineHeight: '1.5'}}><span
            sx={{
                fontSize: '15px',
                color: 'rgb(89, 89, 89)'
              }}><span sx={{
                ...
                events<span sx={{fontSize: '15px'}}><span sx={{color: 'rgb(89, 89, 89)'}}><span
                      data-custom-class="body_text"><span sx={{fontSize: '15px'}}><span sx={{color: 'rgb(89, 89, 89)'}}>
                          <bdt class="statement-end-if-in-editor"></bdt>
                        </span></span></span></span></span></span></span></span></li>
      </ul>
      <div sx={{lineHeight: '1.5'}}><span sx={{fontSize: '15px'}}><span  sx={{color: 'rgb(127, 127, 127)'}}><span
              ...
              do not use our Services.<bdt class="block-component"></bdt> If you still have any questions or concerns,
              please contact us at <bdt class="question">achia@adrianchia.com</bdt>.</span></span></span>
      </div>

      <div sx={{lineHeight: '1.5'}}><br/></div>
      <div sx={{lineHeight: '1.5'}}><br/></div>
      <div sx={{lineHeight: '1.5'}}>
        <strong><span sx={{fontSize: '15px'}}><span data-custom-class="heading_1">SUMMARY OF  KEY POINTS</span></span></strong>
      </div>

      <div sx={{lineHeight: '1.5'}}><br/></div>
      <div sx={{lineHeight: '1.5'}}><span sx={{fontSize: '15px'}}><span data-custom-class="body_text"><strong><em>This
          ...
          data-custom-class="link" href="#toc"><span sx={{color: 'rgb(0, 58, 250)', fontSize: '15px'}}><span
              data-custom-class="body_text"><strong><em>table of contents</em></strong></span></span></a><span
          sx={{fontSize: '15px'}}><span data-custom-class="body_text"><strong><em> below to find the section you are
                looking for.</em></strong></span></span></div>
      <div sx={{lineHeight: '1.5'}}><br/></div>
      <div sx={{lineHeight: '1.5'}}><span sx={{fontSize: '15px'}}><span data-custom-class="body_text"><strong>What
          ...
          href="#personalinfo"><span sx={{color: 'rgb(0, 58, 250)', fontSize: '15px'}}><span
      ...
      <div sx={{lineHeight: '1.5'}}><span sx={{fontSize: '15px'}}><span data-custom-class="body_text"><strong>How do we
            ...
            Learn more about </span></span><a data-custom-class="link" href="#infosafe"><span
      ...
      <div sx={{lineHeight: '1.5'}}><span sx={{fontSize: '15px'}}><span data-custom-class="body_text"><strong>What are
            ...
            you have certain rights regarding your personal information. Learn more about </span></span>
        <a data-custom-class="link" href="#privacyrights"><span sx={{color: 'rgb(0, 58, 250)', fontSize: '15px'}}><span
      ...
      <div sx={{lineHeight: '1.5'}}><br/></div>
      <div sx={{lineHeight: '1.5'}}><br/></div>
      <div id="toc" sx={{lineHeight: '1.5'}}><span sx={{fontSize: '15px'}}><span
            sx={{color: 'rgb(127, 127, 127)'}}><span sx={{color: 'rgb(0, 0, 0)'}}><strong><span
                  data-custom-class="heading_1">TABLE OF CONTENTS</span></strong></span></span></span></div>
      <div sx={{lineHeight: '1.5'}}><br/></div>
      <div sx={{lineHeight: '1.5'}}><span sx={{fontSize: '15px'}}><a data-custom-class="link" href="#infocollect"><span
              sx={{color: 'rgb(0, 58, 250)'}}>1. WHAT INFORMATION DO WE COLLECT?</span></a></span></div>
      <div sx={{lineHeight: '1.5'}}><span sx={{fontSize: '15px'}}><a data-custom-class="link" href="#infouse"><span
              sx={{color: 'rgb(0, 58, 250)'}}>2. HOW DO WE PROCESS YOUR INFORMATION?<bdt class="block-component"></bdt>
              </span></a></span></div>
      <div sx={{lineHeight: '1.5'}}><span sx={{fontSize: '15px'}}><a data-custom-class="link" href="#legalbases"><span
              sx={{color: 'rgb(0, 58, 250)'}}>3. <span sx={{fontSize: '15px'}}><span sx={{color: 'rgb(0, 58, 250)'}}>WHAT
      ...
      <div sx={{lineHeight: '1.5'}}>
        <span sx={{fontSize: '15px'}}>
          <span sx={{color: 'rgb(0, 58, 250)'}}><a data-custom-class="link" href="#whoshare">4. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</a></span>
          <span data-custom-class="body_text">
            <bdt class="block-component"></bdt></span><span sx={{color: 'rgb(127, 127, 127)'}}><span sx={{color: 'rgb(89, 89, 89)'}}><span data-custom-class="body_text"><span sx={{color: 'rgb(89, 89, 89)'}}>
              <bdt class="block-component"></bdt>
            </span></span><span data-custom-class="body_text"><span sx={{color: 'rgb(89, 89, 89)'}}><span
                sx={{color: 'rgb(89, 89, 89)'}}><span sx={{color: 'rgb(89, 89, 89)'}}>
                  <bdt class="block-component"></bdt>
                </span></span>
              <bdt class="block-component"></bdt>
            </span></span></span></span>
      ...
      <div sx={{lineHeight: '1.5'}}><span sx={{fontSize: '15px'}}><a data-custom-class="link" href="#inforetain"><span
        sx={{color: 'rgb(0, 58, 250)'}}>5. HOW LONG DO WE KEEP YOUR INFORMATION?</span></a><span
      sx={{color: 'rgb(127, 127, 127)'}}><span sx={{color: 'rgb(89, 89, 89)'}}><span
          data-custom-class="body_text"><span sx={{color: 'rgb(89, 89, 89)'}}><span sx={{color: 'rgb(89, 89, 89)'}}>
              <bdt class="block-component"></bdt>
            </span></span></span></span></span></span>
      </div>

      <div sx={{lineHeight: '1.5'}}><span sx={{fontSize: '15px'}}><a data-custom-class="link" href="#infosafe"><span
    sx={{color: 'rgb(0, 58, 250)'}}>6. HOW DO WE KEEP YOUR INFORMATION SAFE?</span></a><span
  sx={{color: 'rgb(127, 127, 127)'}}><span sx={{color: 'rgb(89, 89, 89)'}}><span
      data-custom-class="body_text"><span sx={{color: 'rgb(89, 89, 89)'}}>
        <bdt class="statement-end-if-in-editor"></bdt>
        <bdt class="block-component"></bdt>
      </span></span></span></span></span>
      </div>

      <div sx={{lineHeight: '1.5'}}><span sx={{fontSize: '15px'}}><span sx={{color: 'rgb(0, 58, 250)'}}><a
        data-custom-class="link" href="#privacyrights">7. WHAT ARE YOUR PRIVACY RIGHTS?</a></span></span>
      </div>
      <div sx={{lineHeight: '1.5'}}><span sx={{fontSize: '15px'}}><a data-custom-class="link" href="#DNT"><span sx={{color: 'rgb(0, 58, 250)'}}>8. CONTROLS FOR DO-NOT-TRACK FEATURES<bdt class="block-component"></bdt></span></a></span>
      </div>
      <div sx={{lineHeight: '1.5'}}><span sx={{fontSize: '15px'}}><a data-custom-class="link" href="#uslaws"><span sx={{color: 'rgb(0, 58, 250)'}}>9. DO UNITED STATES RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</span></a></span>
      ...
      <div sx={{lineHeight: '1.5'}}>
        ...
        <div sx={{lineHeight: '1.5'}}><span sx={{fontSize: '15px'}}><a data-custom-class="link"
        href="#policyupdates"><span sx={{color: 'rgb(0, 58, 250)'}}>10. DO WE MAKE UPDATES TO THIS
          NOTICE?</span></a></span></div>
        <div sx={{lineHeight: '1.5'}}><a data-custom-class="link" href="#contact"><span
        sx={{color: 'rgb(0, 58, 250)', fontSize: '15px'}}>11. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</span></a>
        </div>
        <div sx={{lineHeight: '1.5'}}><a data-custom-class="link" href="#request"><span sx={{color: 'rgb(0, 58, 250)'}}>12. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</span></a>
        </div>

        <div sx={{lineHeight: '1.5'}}><br/></div>
    <div sx={{lineHeight: '1.5'}}><br/></div>
    <div id="infocollect" sx={{lineHeight: '1.5'}}><span sx={{color: 'rgb(0, 0, 0)'}}><span
          sx={{
            fontSize: '15px',
            color: 'rgb(0, 0, 0)'
          }}><span sx={{
            ...
            color: 'rgb(0, 0, 0)'
                ...
                sx={{color: 'rgb(0, 0, 0)'}}><strong><span data-custom-class="heading_1">1. WHAT INFORMATION DO WE
                    COLLECT?</span></strong></span></span></span></span></span></div>
      <div sx={{lineHeight: '1.5'}}><br/></div>
      <div id="personalinfo" sx={{lineHeight: '1.5'}}><span data-custom-class="heading_2"
          sx={{color: 'rgb(0, 0, 0)'}}><span sx={{fontSize: '15px'}}><strong>Personal information you disclose to
              us</strong></span></span></div>
      <div>
        <div><br/></div>
        <div sx={{lineHeight: '1.5'}}><span sx={{color: 'rgb(127, 127, 127)'}}><span
              sx={{
                      fontSize: '15px',
                      color: 'rgb(89, 89, 89)'
                    }}><span data-custom-class="body_text"><span
                  ...
                  sx={{
                    ...
                    sx={{
                      ...
                      data-custom-class="body_text"><strong><em> </em></strong><em>We collect personal information that
                        you provide to us.</em></span></span></span></span></span></span>
        </div>
      </div>

      <div sx={{lineHeight: '1.5'}}><br/></div>
      <div sx={{lineHeight: '1.5'}}><span sx={{
                fontSize: '15px',
                color: 'rgb(89, 89, 89)'
              }}><span sx={{
                fontSize: '15px',
                color: 'rgb(89, 89, 89)'
              }}><span data-custom-class="body_text">We collect personal
        information that you voluntarily provide to us when you <span sx={{fontSize: '15px'}}>
          <bdt class="block-component"></bdt>
      ...
      <div id="sensitiveinfo" sx={{lineHeight: '1.5'}}><span sx={{fontSize: '15px'}}><span
      ...
      <div sx={{lineHeight: '1.5'}}><span data-custom-class="body_text"><span sx={{fontSize: '15px'}}><strong>Application Data.</strong> If you use our application(s), we also may collect the following information if you choose to provide us with access or permission:<bdt class="block-component"></bdt></span></span>
      </div>

      <div sx={{lineHeight: '1.5'}}>
        <bdt class="block-component"><span sx={{fontSize: '15px'}}>
      ...
      <ul>
        <li data-custom-class="body_text" sx={{lineHeight: '1.5'}}><span sx={{fontSize: '15px'}}><span
              data-custom-class="body_text"><em>Mobile Device Access.</em> We may request access or permission to
              certain features from your mobile device, including your mobile device's <bdt class="forloop-component">
              </bdt>
              <bdt class="question">camera</bdt>, <bdt class="forloop-component"></bdt>and other features. If you wish
              to change our access or permissions, you may do so in your device's settings.<bdt
      ...
      <div sx={{lineHeight: '1.5'}}><span sx={{fontSize: '15px'}}><span data-custom-class="body_text">This
      ...
      <div sx={{lineHeight: '1.5'}}><span
                ...
                color: 'rgb(89, 89, 89)'
                  ...
                  <bdt class="block-component"></bdt>
                      ...
                      data-custom-class="body_text"><span sx={{
                fontSize: '15px',
                color: 'rgb(89, 89, 89)'
              }}><span
      ...
      <div sx={{lineHeight: '1.5'}}><br/></div>
          <div id="infouse" sx={{lineHeight: '1.5'}}><span sx={{color: 'rgb(127, 127, 127)'}}><span
                sx={{
                fontSize: '15px',
                color: 'rgb(89, 89, 89)'
              }}><span
                ...
                color: 'rgb(89, 89, 89)'
                      ...
                      sx={{color: 'rgb(0, 0, 0)'}}><strong><span data-custom-class="heading_1">2. HOW DO WE PROCESS YOUR
      ...
      <div sx={{lineHeight: '1.5'}}><span sx={{
                ...
                fontSize: '15px',
                color: 'rgb(89, 89, 89)'
              }}><span data-custom-class="body_text"><strong>We process
  ...
  <div sx={{lineHeight: '1.5'}}>
      ...
      <ul>
        <li data-custom-class="body_text" sx={{lineHeight: '1.5'}}>
          <span data-custom-class="body_text"><span sx={{fontSize: '15px'}}><strong>To save or protect an
                individual's vital interest.</strong> We may process
      ...
      <div sx={{lineHeight: '1.5'}}><br/></div>
      <div id="legalbases" sx={{lineHeight: '1.5'}}><strong><span
            sx={{fontSize: '15px'}}><span
              data-custom-class="heading_1">3. WHAT LEGAL BASES DO WE
              RELY ON TO PROCESS YOUR
              INFORMATION?</span></span></strong></div>
      <div sx={{lineHeight: '1.5'}}><br/></div>
      <div sx={{lineHeight: '1.5'}}><em><span
        sx={{fontSize: '15px'}}><span
          ...
          a valid legal reason (i.e.<bdt class="block-component">
          ...
          services to enter into or <bdt class="block-component">
          </bdt>fulfill<bdt class="statement-end-if-in-editor">
          </bdt> our contractual obligations, to protect your
          rights, or to <bdt class="block-component"></bdt>fulfill
          <bdt class="statement-end-if-in-editor"></bdt> our
      ...
      sx={{fontSize: '15px'}}><span
        ...
        Regulation (GDPR) and UK GDPR require us to explain the
        valid legal bases we rely on in order to process your
        personal information. As such, we may rely on the
        following legal bases to process your personal
  ...
  <li data-custom-class="body_text" sx={{lineHeight: '1.5'}}>
    <span sx={{fontSize: '15px'}}><span
        ...
        permission (i.e.<bdt class="block-component"></bdt>,<bdt
          class="statement-end-if-in-editor"></bdt> consent) to
      ...
      sx={{color: 'rgb(0, 58, 250)', fontSize: '15px'}}><span
  ...
  <div sx={{lineHeight: '1.5'}}>
    <bdt class="block-component"><span
      ...
      <ul>
        <li data-custom-class="body_text" sx={{lineHeight: '1.5'}}>
          <span data-custom-class="body_text"><span
              sx={{fontSize: '15px'}}><strong>Vital
                Interests.</strong> We may process your information
      ...
      <div sx={{lineHeight: '1.5'}}><span
          data-custom-class="body_text"><span
            sx={{fontSize: '15px'}}><strong><u><em>If you are
                  located in Canada, this section applies to
                  you.</em></u></strong></span></span></div>
      <div sx={{lineHeight: '1.5'}}><br/></div>
      <div sx={{lineHeight: '1.5'}}><span
          data-custom-class="body_text"><span
            sx={{fontSize: '15px'}}>
      ...
      <div sx={{lineHeight: '1.5'}}><span
          data-custom-class="body_text"><span
            sx={{fontSize: '15px'}}>We may process your information
            if you have given us specific permission (i.e.<bdt
            ...
            consent). You can </span></span><a
          data-custom-class="link" href="#withdrawconsent"><span
            data-custom-class="body_text"><span
            sx={{color: 'rgb(0, 58, 250)', fontSize: '15px'}}>withdraw
              your consent</span></span></a><span
          data-custom-class="body_text"><span
            sx={{fontSize: '15px'}}> at any time.</span></span>
      </div>
      <div sx={{lineHeight: '1.5'}}><br/></div>
      <div sx={{lineHeight: '1.5'}}><span
          data-custom-class="body_text"><span
            sx={{fontSize: '15px'}}>In some exceptional cases, we
            may be legally permitted under applicable law to process
            your information without your consent, including, for
            example:</span></span></div>
      <ul>
        <li data-custom-class="body_text" sx={{lineHeight: '1.5'}}>
          <span data-custom-class="body_text"><span
              sx={{fontSize: '15px'}}>If collection is clearly in
              the interests of an individual and consent cannot be
              obtained in a timely way</span></span></li>
      </ul>
      <div sx={{lineHeight: '1.5'}}><span
          data-custom-class="body_text"><span
            sx={{fontSize: '15px'}}>
      ...
      <ul>
        <li data-custom-class="body_text" sx={{lineHeight: '1.5'}}>
          <span data-custom-class="body_text"><span
              sx={{fontSize: '15px'}}>For investigations and fraud
      ...
      <ul>
        <li data-custom-class="body_text" sx={{lineHeight: '1.5'}}>
          <span data-custom-class="body_text"><span
              sx={{fontSize: '15px'}}>For business transactions
      ...
      <ul>
        <li data-custom-class="body_text" sx={{lineHeight: '1.5'}}>
          <span data-custom-class="body_text"><span
              sx={{fontSize: '15px'}}>If it is contained in a
      ...
      <ul>
        <li data-custom-class="body_text" sx={{lineHeight: '1.5'}}>
          <span data-custom-class="body_text"><span
              sx={{fontSize: '15px'}}>For identifying injured, ill,
      ...
      <ul>
        <li data-custom-class="body_text" sx={{lineHeight: '1.5'}}>
          <span data-custom-class="body_text"><span
              sx={{fontSize: '15px'}}>If we have reasonable grounds
              to believe an individual has been, is, or may be
      ...
      <ul>
        <li data-custom-class="body_text" sx={{lineHeight: '1.5'}}>
          <span data-custom-class="body_text"><span
              sx={{fontSize: '15px'}}>If it is reasonable to expect
              collection and use with consent would compromise the
              availability or the accuracy of the information and
              the collection is reasonable for purposes related to
      ...
      <ul>
        <li data-custom-class="body_text" sx={{lineHeight: '1.5'}}>
          <span data-custom-class="body_text"><span
              sx={{fontSize: '15px'}}>If disclosure is required to
              comply with a subpoena, warrant, court order, or rules
              of the court relating to the production of records<bdt
                class="statement-end-if-in-editor"></bdt>
              </span></span></li>
      </ul>
      <div sx={{lineHeight: '1.5'}}>
      ...
      <ul>
        <li data-custom-class="body_text" sx={{lineHeight: '1.5'}}>
          <span sx={{fontSize: '15px'}}><span
              data-custom-class="body_text">If it was produced by an
              individual in the course of their employment,
              business, or profession and the collection is
              consistent with the purposes for which the information
              was produced<bdt class="statement-end-if-in-editor">
              </bdt></span></span></li>
      </ul>
      <div sx={{lineHeight: '1.5'}}><span
          sx={{fontSize: '15px'}}><span
      ...
      <ul>
        <li data-custom-class="body_text" sx={{lineHeight: '1.5'}}>
          <span sx={{fontSize: '15px'}}><span
              ...
              purposes<bdt class="statement-end-if-in-editor"></bdt>
              </span></span></li>
      </ul>
      <div sx={{lineHeight: '1.5'}}><span
          sx={{fontSize: '15px'}}><span
      ...
      <ul>
        <li data-custom-class="body_text" sx={{lineHeight: '1.5'}}>
          <span sx={{fontSize: '15px'}}><span
              data-custom-class="body_text">If the information is
      ...
      <div id="whoshare" sx={{lineHeight: '1.5'}}><span sx={{color: 'rgb(127, 127, 127)'}}><span
            sx={{
                ...
                sx={{
                      fontSize: '15px',
                      color: 'rgb(89, 89, 89)'
                    }}><span id="control" sx={{color: 'rgb(0, 0, 0)'}}><strong><span
      ...
      sx={{
            ...
            Short:</em></strong><em> We may share information
          in specific situations described in this section
          and/or with the following <bdt class="block-component"></bdt>third
...
<div sx={{lineHeight: '1.5'}}><span sx={{fontSize: '15px'}}><span data-custom-class="body_text">We <bdt
      ...
      <ul>
        <li data-custom-class="body_text" sx={{lineHeight: '1.5'}}>
          <span sx={{fontSize: '15px'}}><span data-custom-class="body_text"><strong>Business
      ...
      <div sx={{lineHeight: '1.5'}}><br/></div>
          <div id="inforetain" sx={{lineHeight: '1.5'}}><span sx={{color: 'rgb(127, 127, 127)'}}><span
                ...
                color: 'rgb(89, 89, 89)'
                      ...
                      sx={{color: 'rgb(0, 0, 0)'}}><strong><span data-custom-class="heading_1">5. HOW
      ...
      <div sx={{lineHeight: '1.5'}}><br/></div>
          <div sx={{lineHeight: '1.5'}}><span sx={{
                ...
                fontSize: '15px',
                color: 'rgb(89, 89, 89)'
              }}><span data-custom-class="body_text">We will only
                  ...
                  requirements).<bdt class="block-component"></bdt>
                </span></span></span></div>
          <div sx={{lineHeight: '1.5'}}><br/></div>
          <div sx={{lineHeight: '1.5'}}><span sx={{
                fontSize: '15px',
                ...
                fontSize: '15px',
                color: 'rgb(89, 89, 89)'
              }}><span data-custom-class="body_text">When we have
                  no ongoing legitimate business need to
                  process your personal information, we will
                  either delete or <bdt class="block-component"></bdt>anonymize
                  <bdt class="statement-end-if-in-editor">
                  </bdt> such information, or, if this is not
      ...
      <div sx={{lineHeight: '1.5'}}><br/></div>
      <div id="infosafe" sx={{lineHeight: '1.5'}}><span sx={{
                color: 'rgb(127, 127, 127)'
              }}><span
                                                                                sx={{
                  color: 'rgb(89, 89, 89)',
                  ...
                  fontSize: '15px'
                                                                                      ...
                                                                                      id="control"
                                                                                      sx={{color: 'rgb(0, 0, 0)'}}><strong><span
                                                                                          data-custom-class="heading_1">6. HOW
      ...
      <div sx={{lineHeight: '1.5'}}><br/></div>
            ...
            fontSize: '15px'
                                                                            ...
                                                                            data-custom-class="body_text"><strong><em>In
                                                                              ...
                                                                              protect your personal information through
                                                                              a system of <bdt class="block-component">
      ...
      <div sx={{lineHeight: '1.5'}}><br/></div>
            ...
            fontSize: '15px'
                                                                            ...
                                                                            cybercriminals, or other <bdt
                                                                              class="block-component"></bdt>unauthorized
                                                                            <bdt class="statement-end-if-in-editor">
      ...
      <div sx={{lineHeight: '1.5'}}><br/></div>
                                                                    <div id="privacyrights" sx={{lineHeight: '1.5'}}>
                                                                      <span sx={{
          color: 'rgb(127, 127, 127)'
        }}><span
                                                                          sx={{
            ...
            fontSize: '15px'
                                                                            ...
                                                                            data-custom-class="body_text"><strong><em>In
                                                                              ...
                                                                              the US or in <bdt class="else-block">
                                                                              </bdt>some regions, such as <bdt
                                                                                class="block-component"></bdt>the
                                                                              European Economic Area (EEA), United
                                                                              Kingdom (UK), Switzerland, and Canada<bdt
                                                                                class="block-component"></bdt>, you have
                                                                              rights that allow you greater access to
                                                                              ...
                                                                              information.<span
                                                                                sx={{color: 'rgb(89, 89, 89)'}}><span
                                                                                  sx={{fontSize: '15px'}}><span
                                                                                    ...
                                                                                    </em></span></span> </span>You may
                                                                              review, change, or terminate your account
                                                                              at any time, depending on your country,
            ...
            fontSize: '15px'
                                                                            ...
                                                                            regions (like <bdt class="block-component">
                                                                            </bdt>the EEA, UK, Switzerland, and Canada
                                                                            <bdt class="block-component"></bdt>), you
                                                                            ...
                                                                            section <bdt class="block-component"></bdt>"
                                                                            <bdt class="statement-end-if-in-editor">
                                                                            </bdt></span></span></span><a
                                                                        data-custom-class="link" href="#contact"><span
                                                                          sx={{color: 'rgb(0, 58, 250)', fontSize: '15px'}}><span
                                                                            sx={{color: 'rgb(0, 58, 250)', fontSize: '15px'}}><span
                                                                              data-custom-class="body_text">HOW CAN YOU
            ...
            fontSize: '15px'
                                                                            ...
                                                                            located in the EEA or UK and you believe we
                                                                            are unlawfully processing your personal
                                                                            information, you also have the right to
                                                                            complain to your <span
                                                                              sx={{fontSize: '15px'}}><span
                                                                                sx={{color: 'rgb(0, 58, 250)'}}><span
                                                                                  data-custom-class="body_text"><span
                                                                                    sx={{color: 'rgb(0, 58, 250)'}}><span
                                                                        ...
                                                                        rel="noopener noreferrer" target="_blank"><span
                                                                          sx={{color: 'rgb(0, 58, 250)', fontSize: '15px'}}><span
                                                                            sx={{color: 'rgb(0, 58, 250)', fontSize: '15px'}}><span
                                                                              data-custom-class="body_text">UK data
                                                                              protection
            ...
            fontSize: '15px'
                                                                            ...
                                                                            data-custom-class="body_text">If you are
                                                                            located in Switzerland, you may contact the
                                                                            <span sx={{fontSize: '15px'}}><span
                                                                                sx={{color: 'rgb(0, 58, 250)'}}><span
                                                                                  data-custom-class="body_text"><span
                                                                                    sx={{color: 'rgb(0, 58, 250)'}}><span
                                                                                      data-custom-class="body_text"><span
                                                                                        sx={{color: 'rgb(0, 58, 250)', fontSize: '15px'}}><a
                                                                                          data-custom-class="link"
                                                                                          href="https://www.edoeb.admin.ch/edoeb/en/home.html"
                                                                                          rel="noopener noreferrer"
                                                                                          target="_blank">Federal Data
                                                                                          Protection and Information
                                                                                          Commissioner</a></span></span></span></span></span></span>.</span></span></span>
                                                                    </div>
                                                                    <div sx={{lineHeight: '1.5'}}><br/></div>
                                                                    <div id="withdrawconsent" sx={{lineHeight: '1.5'}}>
                                                                      <span
                                                                        sx={{
            color: 'rgb(89, 89, 89)',
            fontSize: '15px'
            ...
            fontSize: '15px'
                                                                            ...
                                                                            personal information,<bdt
                                                                              class="block-component"></bdt> which may
            ...
            fontSize: '15px'
                                                                            ...
                                                                            <bdt class="block-component"></bdt>"<bdt
                                                                              class="statement-end-if-in-editor"></bdt>
                                                                            below<bdt class="block-component"></bdt>.
                                                                          </span></span></span></div>
                                                                          <div sx={{lineHeight: '1.5'}}><br/></div>
                                                                    <div sx={{lineHeight: '1.5'}}><span
                                                                        sx={{fontSize: '15px'}}><span
                                                                          data-custom-class="body_text">However, please
                                                                          note that this will not affect the lawfulness
                                                                          of the processing before its withdrawal nor,
                                                                          <bdt class="block-component"></bdt> when
      ...
      <div sx={{lineHeight: '1.5'}}><span
          data-custom-class="body_text"><span
            sx={{fontSize: '15px'}}>If you have questions
            or comments about your privacy rights, you may
            email us at <bdt class="question">
              achia@adrianchia.com</bdt>.</span></span>
        <bdt class="statement-end-if-in-editor"><span
            sx={{fontSize: '15px'}}><span
              data-custom-class="body_text"></span></span>
        </bdt>
      ...
      <div sx={{lineHeight: '1.5'}}><br/></div>
      <div id="DNT" sx={{lineHeight: '1.5'}}><span
          sx={{
            color: 'rgb(127, 127, 127)'
            }}><span
                        sx={{
      ...
      <div sx={{lineHeight: '1.5'}}><br/></div>
            ...
            fontSize: '15px'
              ...
              Do-Not-Track (<bdt class="block-component">
              </bdt>"DNT"<bdt
                class="statement-end-if-in-editor"></bdt>)
              ...
              uniform technology standard for <bdt
                class="block-component"></bdt>recognizing
              <bdt class="statement-end-if-in-editor">
              </bdt> and implementing DNT signals has been
              <bdt class="block-component"></bdt>finalized
              <bdt class="statement-end-if-in-editor">
              </bdt>. As such, we do not currently respond
              ...
              of this privacy notice.</span></span></span>
        <bdt class="block-component"><span
            sx={{fontSize: '15px'}}></span></bdt>
      </div>
      <div sx={{lineHeight: '1.5'}}><span
                                                                        sx={{fontSize: '15px'}}><br/></span></div>
        <div sx={{lineHeight: '1.5'}}><span
            sx={{fontSize: '15px'}}><span
              data-custom-class="body_text">California law
              requires us to let you know how we respond to
              web browser DNT signals. Because there
              currently is not an industry or legal standard
              for <bdt class="block-component"></bdt>
              recognizing<bdt
                class="statement-end-if-in-editor"></bdt> or
              <bdt class="block-component"></bdt>honoring
              <bdt class="statement-end-if-in-editor"></bdt>
...
fontSize: '15px'
      ...
      <div sx={{lineHeight: '1.5'}}><br/></div>
<div id="uslaws" sx={{lineHeight: '1.5'}}><span
    sx={{
color: 'rgb(127, 127, 127)'
}}><span
      sx={{
...
fontSize: '15px'
            ...
            id="control"
            sx={{color: 'rgb(0, 0, 0)'}}><strong><span
                data-custom-class="heading_1">9. DO
                UNITED STATES RESIDENTS HAVE
                SPECIFIC PRIVACY
                RIGHTS?</span></strong></span></span></span></span></span>
</div>
<div sx={{lineHeight: '1.5'}}><br/></div>
...
fontSize: '15px'
        ...
        data-custom-class="body_text"><strong><em>In
            Short: </em></strong><em>If you are a
          resident of<bdt class="block-component">
          </bdt> California, Colorado, Connecticut,
          Delaware, Florida, Indiana, Iowa,
          Kentucky, Montana, New Hampshire, New
          Jersey, Oregon, Tennessee, Texas, Utah, or
          Virginia<bdt class="else-block"></bdt>,
          you may have the right to request access
          to and receive details about the personal
          information we maintain about you and how
          we have processed it, correct
          inaccuracies, get a copy of, or delete
          your personal information. You may also
...
fontSize: '15px'
      ...
      <table sx={{width: '100%'}}>
        <tbody>
          <tr>
            <td
              sx={{width: '33.8274%', borderLeft: '1px solid black', borderRight: '1px solid black', borderTop: '1px solid black'}}>
              <span
                sx={{
      color: 'rgb(89, 89, 89)',
      fontSize: '15px'
      ...
      fontSize: '15px'
            ...
            <td
              sx={{width: '51.4385%', borderTop: '1px solid black', borderRight: '1px solid black'}}>
              <span
                sx={{
      color: 'rgb(89, 89, 89)',
      fontSize: '15px'
      ...
      fontSize: '15px'
            ...
            <td
              sx={{width: '14.9084%', borderRight: '1px solid black', borderTop: '1px solid black', textAlign: 'center'}}>
              <span
                sx={{
      color: 'rgb(89, 89, 89)',
      fontSize: '15px'
...
fontSize: '15px'
                ...
                data-custom-class="body_text">
                <bdt class="block-component"></bdt>C
                <bdt class="else-block"></bdt>.
      ...
      <td
        ...
        <div data-custom-class="body_text"
          ...
          <bdt class="forloop-component"><span
              data-custom-class="body_text">
              <bdt class="block-component"></bdt>
              <bdt class="block-component"></bdt>NO
              <bdt
                class="statement-end-if-in-editor">
              </bdt>
              <bdt class="block-component"></bdt>
...
fontSize: '15px'
                ...
                data-custom-class="body_text">
                <bdt class="block-component"></bdt>D
                <bdt class="else-block"></bdt>.
...
fontSize: '15px'
                ...
                data-custom-class="body_text">
                <bdt class="block-component"></bdt>E
                <bdt class="else-block"></bdt>.
...
fontSize: '15px'
                ...
                and voiceprints</span></span></span>
        </div>
      </td>
      <td
        sx={{width: '14.9084%', borderRight: '1px solid black', borderTop: '1px solid black', textAlign: 'center'}}>
...
fontSize: '15px'
                ...
                data-custom-class="body_text">
                <bdt class="block-component"></bdt>F
                <bdt class="else-block"></bdt>.
...
fontSize: '15px'
                ...
                history, search history, online <bdt
...
fontSize: '15px'
                ...
                data-custom-class="body_text">
                <bdt class="block-component"></bdt>G
                <bdt class="else-block"></bdt>.
                Geolocation data
              </span></span></span></div>
      </td>
...
fontSize: '15px'
                ...
                data-custom-class="body_text">
                <bdt class="block-component"></bdt>H
                <bdt class="else-block"></bdt>.
...
fontSize: '15px'
                ...
                data-custom-class="body_text">
                <bdt class="block-component"></bdt>I
                <bdt class="else-block"></bdt>.
...
fontSize: '15px'
                ...
                data-custom-class="body_text">
                <bdt class="block-component"></bdt>J
                <bdt class="else-block"></bdt>.
...
fontSize: '15px'
    ...
    <tr>
      <td
        sx={{borderWidth: '1px', borderColor: 'black', borderStyle: 'solid', width: '33.8274%'}}>
        <div sx={{lineHeight: '1.5'}}><span
            sx={{
color: 'rgb(89, 89, 89)',
fontSize: '15px'
...
fontSize: '15px'
                ...
                data-custom-class="body_text">
                <bdt class="block-component"></bdt>K
                <bdt class="else-block"></bdt>.
    ...
    <tr>
      <td
        ...
        <span data-custom-class="body_text">
          <bdt class="block-component"></bdt>L<bdt
            class="else-block"></bdt>. Sensitive
          personal Information
        </span></td>
      <td
        sx={{
      ...
      <ul>
        <li data-custom-class="body_text"
          sx={{lineHeight: '1.5'}}><span
            sx={{fontSize: '15px'}}>Receiving help
            through our customer support channels;<bdt
              class="statement-end-if-in-editor"></bdt>
            </span></li>
      </ul>
      ...
      <ul>
        <li data-custom-class="body_text"><span
            sx={{fontSize: '15px'}}>Participation in
            customer surveys or contests; and<bdt
              class="statement-end-if-in-editor"></bdt>
            </span></li>
      </ul>
      <div><span sx={{fontSize: '15px'}}>
      ...
      <ul>
        <li data-custom-class="body_text"><span
            sx={{fontSize: '15px'}}>Facilitation in the
      ...
      <div sx={{lineHeight: '1.5' }}><strong><span sx={{fontSize: '15px' }}><span data-custom-class="heading_2">Sources of
        Personal
        Information</span></span></strong></div>
        <div sx={{lineHeight: '1.5'}}><br/></div>
        <div sx={{lineHeight: '1.5'}}><span
            sx={{fontSize: '15px'}}><span
              ...
              about the sources of personal information we
              collect in <bdt class="block-component">
              </bdt>"<bdt
                class="statement-end-if-in-editor"></bdt>
              </span></span><span
            data-custom-class="body_text"><a
              ...
              href="#infocollect"><span
                sx={{color: 'rgb(0, 58, 250)', fontSize: '15px'}}>WHAT
                INFORMATION DO WE
      ...
      <div sx={{lineHeight: '1.5'}}>
        <span sx={{
                ...
                <span sx={{
                  color: 'rgb(89, 89, 89)',
                  fontSize: '15px'
                }}><strong><span data-custom-class="heading_2">How We Use and Share Personal Information</span></strong></span></span>
      </div>
      <div sx={{lineHeight: '1.5'}}><br/></div>
      <div sx={{lineHeight: '1.5'}}><span data-custom-class="body_text" sx={{fontSize: '15px'}}>Learn about how we use your personal information in the section,
          <bdt class="block-component"></bdt>"<bdt
            class="statement-end-if-in-editor"></bdt>
          </span><a data-custom-class="link"
          href="#infouse"><span
            sx={{color: 'rgb(0, 58, 250)', fontSize: '15px'}}>HOW
            DO WE PROCESS YOUR
...
<div sx={{lineHeight: '1.5'}}><span sx={{
          ...
          <span sx={{
            color: 'rgb(89, 89, 89)',
            fontSize: '15px'
          }}><span data-custom-class="body_text"><span sx={{
            color: 'rgb(89, 89, 89)',
            fontSize: '15px'
          }}><span data-custom-class="body_text">
          <bdt class="block-component"></bdt>
      ...
      <div sx={{lineHeight: '1.5' }}><br /></div>
      <div sx={{lineHeight: '1.5' }}><span sx={{ color: 'rgb(89, 89, 89)' , fontSize: '15px' }}><span sx={{
            color: 'rgb(89, 89, 89)' , fontSize: '15px' }}><span data-custom-class="body_text">We may
              disclose your personal information with
              our service providers pursuant to a
              written contract between us and each
              service provider. Learn more about how we
              disclose personal information to in the
              section, <bdt class="block-component">
              </bdt>"<bdt class="statement-end-if-in-editor">
              </bdt></span></span></span><a data-custom-class="link" href="#whoshare"><span sx={{color: 'rgb(0, 58, 250)' ,
            fontSize: '15px' }}><span sx={{color: 'rgb(0, 58, 250)' , fontSize: '15px' }}>WHEN
              AND WITH WHOM DO WE SHARE YOUR PERSONAL
              INFORMATION?</span></span></a><span sx={{ color: 'rgb(89, 89, 89)' , fontSize: '15px' }}><span sx={{
            color: 'rgb(89, 89, 89)' , fontSize: '15px' }}><span data-custom-class="body_text">
              <bdt class="block-component"></bdt>"<bdt class="statement-end-if-in-editor">
              </bdt>
            </span></span></span></div>
      <div sx={{lineHeight: '1.5' }}><br /></div>
      <div sx={{lineHeight: '1.5' }}><span sx={{ color: 'rgb(89, 89, 89)' , fontSize: '15px' }}><span sx={{
            color: 'rgb(89, 89, 89)' , fontSize: '15px' }}><span data-custom-class="body_text">We may use
              your personal information for our own
              business purposes, such as for undertaking
              internal research for technological
              development and demonstration. This is not
              considered to be <bdt class="block-component"></bdt>"selling"
              <bdt class="statement-end-if-in-editor">
              </bdt> of your personal information.<span sx={{ color: 'rgb(89, 89, 89)' , fontSize: '15px' }}><span
                  data-custom-class="body_text">
                  <bdt class="block-component"></bdt>
                </span></span>
            </span></span></span>
      ...
      <div sx={{lineHeight: '1.5' }}><br /></div>
      <div sx={{lineHeight: '1.5' }}><span sx={{ color: 'rgb(89, 89, 89)' , fontSize: '15px' }}><span sx={{
  color: 'rgb(89, 89, 89)' , fontSize: '15px' }}><span data-custom-class="body_text">We have not
    disclosed, sold, or shared any personal
    information to third parties for a
    business or commercial purpose in the
    preceding twelve (12) months. We<span sx={{color: 'rgb(89, 89, 89)' }}> </span>will
    not sell or share personal information in
    the future belonging to website visitors,
    users, and other consumers.<span sx={{color: 'rgb(89, 89, 89)' }}><span data-custom-class="body_text"><span
          sx={{color: 'rgb(89, 89, 89)' }}><span data-custom-class="body_text"><span sx={{color: 'rgb(89, 89, 89)'
              }}><span data-custom-class="body_text">
                <bdt class="statement-end-if-in-editor">
                </bdt>
              </span></span></span></span>
...
data-custom-class="body_text"><span sx={{color: 'rgb(0, 0, 0)' }}><span data-custom-class="body_text">
    <bdt class="block-component"></bdt></span></span></span>

</div>
<div sx={{lineHeight: '1.5' }}><br /></div>
<div sx={{lineHeight: '1.5' }}><span sx={{fontSize: '15px' }}><strong><span data-custom-class="heading_2">Your
        Rights</span></strong></span></div>
<div sx={{lineHeight: '1.5' }}><span sx={{fontSize: '15px' }}><br /></span></div>
<div sx={{lineHeight: '1.5' }}><span sx={{fontSize: '15px' }}><span data-custom-class="body_text">You have
      rights under certain US state data
      protection laws. However, these rights are
      not absolute, and in certain cases, we may
      decline your request as permitted by law.
      These rights include:</span>
    <bdt class="block-component"></bdt>
  </span></div>
<ul>
  <li data-custom-class="body_text" sx={{lineHeight: '1.5' }}><span sx={{fontSize: '15px' }}><strong>Right to
        know</strong> whether or not we are
      processing your personal data<bdt class="statement-end-if-in-editor"></bdt>
    </span></li>
</ul>
...
<ul>
  <li data-custom-class="body_text" sx={{lineHeight: '1.5' }}><span sx={{fontSize: '15px' }}><strong>Right to
        access </strong>your personal data<bdt class="statement-end-if-in-editor"></bdt>
    </span></li>
</ul>
<div sx={{lineHeight: '1.5' }}><span sx={{fontSize: '15px' }}>
    <bdt class="block-component"></bdt>
...
<ul>
  <li data-custom-class="body_text" sx={{lineHeight: '1.5' }}><span sx={{fontSize: '15px' }}><strong>Right to
        correct </strong>inaccuracies in your
      personal data<bdt class="statement-end-if-in-editor"></bdt>
    </span></li>
</ul>
<div sx={{lineHeight: '1.5' }}><span sx={{fontSize: '15px' }}>
    <bdt class="block-component"></bdt>
...
<ul>
  <li data-custom-class="body_text" sx={{lineHeight: '1.5' }}><span sx={{fontSize: '15px' }}><strong>Right to
        request</strong> the deletion of your
      personal data<bdt class="statement-end-if-in-editor"></bdt>
    </span></li>
</ul>
<div sx={{lineHeight: '1.5' }}><span sx={{fontSize: '15px' }}>
...
<ul>
  <li data-custom-class="body_text" sx={{lineHeight: '1.5' }}><span sx={{fontSize: '15px' }}><strong>Right to
        obtain a copy </strong>of the personal
      data you previously shared with us<bdt class="statement-end-if-in-editor"></bdt>
    </span></li>
</ul>
<div sx={{lineHeight: '1.5' }}><span sx={{fontSize: '15px' }}>
    <bdt class="block-component"></bdt>
...
<ul>
  <li data-custom-class="body_text" sx={{lineHeight: '1.5' }}><span sx={{fontSize: '15px' }}><strong>Right to
        non-discrimination</strong> for exercising
      your rights<bdt class="statement-end-if-in-editor"></bdt>
    </span></li>
</ul>
<div sx={{lineHeight: '1.5' }}><span sx={{fontSize: '15px' }}>
    <bdt class="block-component"></bdt>
...
<ul>
  <li data-custom-class="body_text" sx={{lineHeight: '1.5' }}><span sx={{fontSize: '15px' }}><strong>Right to
        opt out</strong> of the processing of your
      personal data if it is used for targeted
      advertising<bdt class="block-component">
      </bdt> (or sharing as defined under
      California’s privacy law)<bdt class="statement-end-if-in-editor"></bdt>,
      the sale of personal data, or profiling in
      furtherance of decisions that produce legal
      or similarly significant effects (<bdt class="block-component"></bdt>"profiling"
      <bdt class="statement-end-if-in-editor">
      </bdt>)<bdt class="statement-end-if-in-editor"></bdt>
    </span></li>
</ul>
...
<div sx={{lineHeight: '1.5' }}><span sx={{fontSize: '15px' }}><span data-custom-class="body_text">Depending upon
      the state where you live, you may also have
      the following rights:</span>
    <bdt class="block-component"></bdt>
  </span></div>
<ul>
  <li data-custom-class="body_text" sx={{lineHeight: '1.5' }}><span sx={{fontSize: '15px' }}>Right to obtain a
      list of the categories of third parties to
      which we have disclosed personal data (as
      permitted by applicable law, including<bdt class="block-component"></bdt>
      California's and Delaware's<bdt class="else-block"></bdt> privacy law)<bdt class="statement-end-if-in-editor">
      </bdt>
    </span></li>
</ul>
<div sx={{lineHeight: '1.5' }}>
...
<ul>
  <li data-custom-class="body_text" sx={{lineHeight: '1.5' }}><span sx={{fontSize: '15px' }}>Right to obtain a
      ...
      by applicable law, including Oregon’s
      privacy law)</span>
...
<ul>
  <li data-custom-class="body_text" sx={{lineHeight: '1.5' }}><span sx={{fontSize: '15px' }}>Right to limit use
      and disclosure of sensitive personal data
      (as permitted by applicable law, including
      California’s privacy law)</span>
    <bdt class="statement-end-if-in-editor"><span sx={{fontSize: '15px' }}></span></bdt>
  </li>
</ul>
<div sx={{lineHeight: '1.5' }}>
...
<ul>
  <li data-custom-class="body_text" sx={{lineHeight: '1.5' }}><span sx={{fontSize: '15px' }}>Right to opt out of
      the collection of sensitive data and
      personal data collected through the
      operation of a voice or facial recognition
      feature (as permitted by applicable law,
      including Florida’s privacy law)</span>
    <bdt class="statement-end-if-in-editor"><span sx={{fontSize: '15px' }}></span></bdt>
  </li>
</ul>
<div sx={{lineHeight: '1.5' }}><span sx={{fontSize: '15px' }}>
    <bdt class="statement-end-if-in-editor"></bdt>
      ...
      <div sx={{lineHeight: '1.5' }}><strong><span sx={{fontSize: '15px' }}><span data-custom-class="heading_2">How to
        Exercise Your
        Rights</span></span></strong></div>
<div sx={{lineHeight: '1.5' }}><br /></div>
<div sx={{lineHeight: '1.5' }}>
  <span sx={{ color: 'rgb(89, 89, 89)' , fontSize: '15px' }}>
    <span sx={{color: 'rgb(89, 89, 89)' , fontSize: '15px' }}>
      <span data-custom-class="body_text">To exercise these rights, you can contact us <bdt class="block-component"></bdt>by submitting a </span>
    </span>
  </span>
  <a data-custom-class="link" href="https://app.termly.io/notify/b735e9ba-5639-47d2-9c1f-e01b3c242099" rel="noopener noreferrer"
    target="_blank">
    <span sx={{color: 'rgb(0, 58, 250)', fontSize: '15px' }}>
      <span sx={{color: 'rgb(0, 58, 250)', fontSize: '15px' }}>data subject access request</span>
    </span>
  </a>
  <span sx={{ color: 'rgb(89, 89, 89)' , fontSize: '15px' }}>
    <span sx={{color: 'rgb(89, 89, 89)' , fontSize: '15px' }}>
        ...
        <span data-custom-class="body_text">
          <span sx={{color: 'rgb(89, 89, 89)' , fontSize: '15px' }}>
            ...
            <span data-custom-class="body_text">
              ...
              <bdt class="block-component">
                <span data-custom-class="body_text">
                  <bdt class="block-component">by  emailing us at </bdt>
                  <bdt class="question">
                    achia@adrianchia.com</bdt>,
                  <bdt class="statement-end-if-in-editor">
                  </bdt>
                  </span>
              </bdt>
...
<div sx={{lineHeight: '1.5' }}><br /></div>
<div sx={{lineHeight: '1.5' }}><span sx={{fontSize: '15px' }}><span data-custom-class="body_text">Under certain
      US state data protection laws, you can
      designate an <bdt class="block-component">
      </bdt>authorized<bdt class="statement-end-if-in-editor"></bdt>
      agent to make a request on your behalf. We
      may deny a request from an <bdt class="block-component"></bdt>authorized
      <bdt class="statement-end-if-in-editor">
      </bdt> agent that does not submit proof that
      they have been validly <bdt class="block-component"></bdt>authorized
      <bdt class="statement-end-if-in-editor">
      </bdt> to act on your behalf in accordance
      with applicable laws.
    </span><br /></span>
</div>
<div sx={{lineHeight: '1.5' }}><br /></div>
<div sx={{lineHeight: '1.5' }}><span sx={{fontSize: '15px' }}><strong><span data-custom-class="heading_2">Request
        Verification</span></strong></span></div>
<div sx={{lineHeight: '1.5' }}><span sx={{fontSize: '15px' }}><br /></span></div>
<div sx={{lineHeight: '1.5' }}><span sx={{fontSize: '15px' }}><span data-custom-class="body_text">Upon receiving
      your request, we will need to verify your
      identity to determine you are the same
      person about whom we have the information in
      our system. We will only use personal
      information provided in your request to
      verify your identity or authority to make
      the request. However, if we cannot verify
      your identity from the information already
      maintained by us, we may request that you
      provide additional information for the
      purposes of verifying your identity and for
      security or fraud-prevention
      purposes.</span></span></div>
<div sx={{lineHeight: '1.5' }}><span sx={{fontSize: '15px' }}><br /></span></div>
<div sx={{lineHeight: '1.5' }}><span sx={{fontSize: '15px' }}><span data-custom-class="body_text">If you submit
      the request through an <bdt class="block-component"></bdt>authorized
      <bdt class="statement-end-if-in-editor">
      </bdt> agent, we may need to collect
      additional information to verify your
      identity before processing your request and
      the agent will need to provide a written and
      signed permission from you to submit such
      request on your behalf.
    </span></span>
  <bdt class="block-component"><span sx={{fontSize: '15px' }}></span></bdt>
</div>
<div sx={{lineHeight: '1.5' }}><span sx={{fontSize: '15px' }}><br /></span></div>
<div sx={{lineHeight: '1.5' }}><span sx={{fontSize: '15px' }}><span
      data-custom-class="heading_2"><strong>Appeals</strong></span></span>
</div>
<div sx={{lineHeight: '1.5' }}><span sx={{fontSize: '15px' }}><br /></span></div>
<div sx={{lineHeight: '1.5' }}><span sx={{fontSize: '15px' }}><span data-custom-class="body_text">Under certain
      US state data protection laws, if we decline
      to take action regarding your request, you
      may appeal our decision by emailing us at
      <bdt class="block-component"></bdt>
      <bdt class="question">achia@adrianchia.com
      </bdt>
      <bdt class="else-block"></bdt>. We will
      inform you in writing of any action taken or
      not taken in response to the appeal,
      including a written explanation of the
      reasons for the decisions. If your appeal is
      denied, you may submit a complaint to your
      state attorney general.
    </span>
    <bdt class="statement-end-if-in-editor"></bdt>
  </span><span sx={{ color: 'rgb(89, 89, 89)' , fontSize: '15px' }}><span sx={{ color: 'rgb(89, 89, 89)' ,
      fontSize: '15px' }}><span sx={{ color: 'rgb(89, 89, 89)' , fontSize: '15px' }}><span
          data-custom-class="body_text">
          <bdt class="block-component">
        </bdt></span>
      </span></span></span>
...
<div sx={{lineHeight: '1.5' }}><span sx={{fontSize: '15px' }}><br /></span></div>
<div sx={{lineHeight: '1.5' }}><span sx={{fontSize: '15px' }}><strong><span data-custom-class="heading_2">California
        <bdt class="block-component"></bdt>"Shine
        The Light"<bdt class="statement-end-if-in-editor">
        </bdt> Law
      </span></strong></span></div>
<div sx={{lineHeight: '1.5' }}><span sx={{fontSize: '15px' }}><br /></span></div>
<div sx={{lineHeight: '1.5' }}>
  <span sx={{fontSize: '15px' }}>
    <span data-custom-class="body_text">California
      Civil Code Section 1798.83, also known as
      the <bdt class="block-component"></bdt>
      "Shine The Light"<bdt class="statement-end-if-in-editor"></bdt>
      ...
      about categories of personal information (if
      any) we disclosed to third parties for
      direct marketing purposes and the names and
      ...
      request in writing to us by using the
      contact details provided in the section <bdt class="block-component"></bdt>"<bdt
        class="statement-end-if-in-editor"></bdt>
    </span>
  </span>
  <span data-custom-class="body_text">
    <a data-custom-class="link" href="#contact">
      <span sx={{color: 'rgb(0, 58, 250)' , fontSize: '15px' }}>HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</span>
    </a>
  </span>
  <span sx={{fontSize: '15px' }}>
    <span data-custom-class="body_text">
...
<div sx={{lineHeight: '1.5' }}><br /></div>
<div id="policyupdates" sx={{lineHeight: '1.5' }}>
  <span sx={{ color: 'rgb(127, 127, 127)' }}><span sx={{ color: 'rgb(89, 89, 89)' , fontSize: '15px' }}><span sx={{
        color: 'rgb(89, 89, 89)' , fontSize: '15px' }}><span sx={{ color: 'rgb(89, 89, 89)' , fontSize: '15px' }}><span
            id="control" sx={{color: 'rgb(0, 0, 0)' }}><strong><span data-custom-class="heading_1">10.
                DO WE MAKE UPDATES TO THIS
                NOTICE?</span></strong></span></span></span></span></span>
</div>
<div sx={{lineHeight: '1.5' }}><br /></div>
<div sx={{lineHeight: '1.5' }}><span sx={{ color: 'rgb(89, 89, 89)' , fontSize: '15px' }}><span sx={{
      color: 'rgb(89, 89, 89)' , fontSize: '15px' }}><span data-custom-class="body_text"><em><strong>In
...
<div sx={{lineHeight: '1.5' }}><br /></div>
<div id="contact" sx={{lineHeight: '1.5' }}><span sx={{ color: 'rgb(127, 127, 127)' }}><span sx={{
      color: 'rgb(89, 89, 89)' , fontSize: '15px' }}><span sx={{ color: 'rgb(89, 89, 89)' , fontSize: '15px' }}><span
          sx={{ color: 'rgb(89, 89, 89)' , fontSize: '15px' }}><span id="control" sx={{color: 'rgb(0, 0, 0)'
            }}><strong><span data-custom-class="heading_1">11.
                HOW CAN YOU CONTACT US ABOUT THIS
                NOTICE?</span></strong></span></span></span></span></span>
</div>
<div sx={{lineHeight: '1.5' }}><br /></div>
<div sx={{lineHeight: '1.5' }}><span sx={{ color: 'rgb(89, 89, 89)' , fontSize: '15px' }}><span sx={{
      color: 'rgb(89, 89, 89)' , fontSize: '15px' }}><span data-custom-class="body_text">If you have
        questions or comments about this notice,
        you may <span sx={{ color: 'rgb(89, 89, 89)' , fontSize: '15px' }}><span data-custom-class="body_text">
            <bdt class="block-component">
              <bdt class="block-component"></bdt>
            </bdt>email us at <bdt class="question">
              achia@adrianchia.com or </bdt>
            <bdt class="statement-end-if-in-editor">
              <bdt class="block-component"></bdt>
            </bdt>
          </span></span><span sx={{ color: 'rgb(89, 89, 89)' , fontSize: '15px' }}><span sx={{ color: 'rgb(89, 89, 89)'
            , fontSize: '15px' }}><span data-custom-class="body_text">contact
              us by post
              at:</span></span></span></span></span></span>
</div>
<div sx={{lineHeight: '1.5' }}><br /></div>
<div sx={{lineHeight: '1.5' }}><span sx={{ color: 'rgb(89, 89, 89)' , fontSize: '15px' }}><span sx={{
      color: 'rgb(89, 89, 89)' , fontSize: '15px' }}><span data-custom-class="body_text"><span sx={{fontSize: '15px'
          }}><span sx={{color: 'rgb(89, 89, 89)' }}><span sx={{color: 'rgb(89, 89, 89)' }}><span
                data-custom-class="body_text">
                <bdt class="question">Adrian Chia
                </bdt>
              </span></span></span></span></span><span data-custom-class="body_text"><span sx={{color: 'rgb(89, 89, 89)'
          }}><span data-custom-class="body_text">
            <bdt class="block-component"></bdt>
          </span></span></span></span></span></div>
<div sx={{lineHeight: '1.5' }}><span sx={{fontSize: '15px' }}><span data-custom-class="body_text">
      <bdt class="question">3019 Village Creek Dr
      </bdt><span sx={{color: 'rgb(89, 89, 89)' }}><span sx={{fontSize: '15px' }}>
          <bdt class="block-component"></bdt>
        </span></span>
    </span>
    </span>
...
<div sx={{lineHeight: '1.5' }}><span sx={{fontSize: '15px' }}><span data-custom-class="body_text">
      <bdt class="question">Katy</bdt><span sx={{color: 'rgb(89, 89, 89)' }}><span sx={{fontSize: '15px' }}>
          <bdt class="block-component"></bdt>
          <bdt class="block-component"></bdt>,
          <bdt class="question">TX</bdt>
          <bdt class="statement-end-if-in-editor">
          </bdt>
          <bdt class="block-component"></bdt>
          <bdt class="block-component"></bdt>
          <bdt class="question">77494</bdt>
          <bdt class="statement-end-if-in-editor">
          </bdt>
          <bdt class="block-component"></bdt>
          <bdt class="block-component"></bdt>
    ...
    <div sx={{lineHeight: '1.5' }}><br /></div>
<div id="request" sx={{lineHeight: '1.5' }}><span sx={{ color: 'rgb(127, 127, 127)' }}><span sx={{
      color: 'rgb(89, 89, 89)' , fontSize: '15px' }}><span sx={{ color: 'rgb(89, 89, 89)' , fontSize: '15px' }}><span
          sx={{ color: 'rgb(89, 89, 89)' , fontSize: '15px' }}><span id="control" sx={{color: 'rgb(0, 0, 0)'
            }}><strong><span data-custom-class="heading_1">12.
...
<div sx={{lineHeight: '1.5' }}>
  <span sx={{ color: 'rgb(89, 89, 89)' , fontSize: '15px' }}>
    ...
    <span data-custom-class="body_text">
        ...
        on the applicable laws of your country<bdt class="block-component"></bdt> or state
        of residence in the US<bdt class="statement-end-if-in-editor">
        </bdt>, you may<bdt class="else-block">
          <bdt class="block-component"> have the
            right to request access to the
            personal information we collect from
            you, details about how we have
            processed it, correct inaccuracies, or
            delete your personal information. You
            may also have the right to withdraw
            your consent to our processing of your
            ...
            information, please <bdt class="block-component"></bdt>fill
            out and submit a 
      </bdt></bdt></span>
